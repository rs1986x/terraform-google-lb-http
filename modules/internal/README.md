...
```HCL
module "gce-lb-http" {
  source            = "GoogleCloudPlatform/lb-http/google//modules/internal"
  version           = "~> 4.4"
...
| region | Names of the region for the internal http LB | `string` | `"europe-west1"` | no |
...
| subnetwork | ID of the subnet to create the internal http LB in | `string` | n/a | yes |
...
| internal\_ip | The internal IPv4 assigned to the global fowarding rule. |
